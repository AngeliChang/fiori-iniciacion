		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#firmanamefacturas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"firmanamefacturas-display": {
								"semanticObject": "firmanamefacturas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=firmaname.facturas",
									"url": sap.ui.require.toUrl("firmaname/facturas")
								}
							}
						}
					}
